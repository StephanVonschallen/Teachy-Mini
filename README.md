# Teachy Mini
Tutoring robot prototype for university students built on Reachy Mini (Pollen Robotics). May be used for replication of the study: "Teachy Mini: A Knowledge-Based Generative Social Tutoring Robot for Higher Education"
